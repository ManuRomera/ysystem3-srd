...
function pj({ name, raza, edad, profesion, alineamiento, attrs, salud, jamacuco, yayos, arquetipo, talento, defectos, familia, pertenencias, hechizos, d3, d2 }) {
  return {
    ...
    system: {
      ...
      puntoGuion: { valor: 0, max: 0, usado: false, nota: "" },
